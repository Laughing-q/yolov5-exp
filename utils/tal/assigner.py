...
from .iou2d_calculator import iou2d_calculator
...
def select_candidates_in_gts(xy_centers, gt_bboxes, eps=1e-9):
    ...
    _gt_bboxes = gt_bboxes.reshape([-1, 4])  # (b*n_max_boxes, 4)
...
def iou_calculator(box1, box2, eps=1e-9):
    ...
    box2 = box2.unsqueeze(1)  # bs, 1, n_max_boxes, 4
...
class TaskAlignedAssigner(nn.Module):
    ...
    def forward(self, pd_scores, pd_bboxes, anc_points, gt_labels, gt_bboxes, mask_gt):
        ...
        # b, max_num_obj, h*w -> b, h*w  -> b, h*w, 1
    ...
    def select_topk_candidates(self, metrics, largest=True, topk_mask=None):
        ...
        # since empty labels will generate index `0` by `F.one_hot`
